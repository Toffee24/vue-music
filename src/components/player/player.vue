      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          <div class="dot-wrapper">
            ...
            <span class="dot" :class="{'active':currentShow==='active'}"></span>
          </div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.player.on('timeupdate', _self.updateTime)
      this.player.on('ended', _self.end)
      this.audio = document.getElementsByTagName('audio')[0]
      this.audio.addEventListener('canplay', () => {
        console.log(_self.player.data)
        _self.songReady = true
      })
    ...
    methods: {
      ...
      afterEnter() {
        ...
        this.$refs.cdWrapper.style.animation = prefixStyle('tr')
      },
      leave(el, done) {
      ...
      format(interval) {
        interval = interval | 0 // 相当于math.flow 取整
    ...
    watch: {
      currentSong(val, oldVal) {
        ...
        this.player.play(val.mid)
        this.getLyric()
      },
      playing(newPlaying) {
        !newPlaying ? this.player.pause() : this.player.play()
      }
    },
    components: {
      ProgressBar,
